...
<section>
    <div class="row padding-small">
        <h1 align="center">SZCZEGÓŁY AKTORA</h1>
        <hr>
            ...
            <div class="mt-4 ml-4 mr-4">
                <div class="row border-bottom border-3">
                    <div class="col d-flex justify-content-end mb-2">
                        <a href="/guest/actors" class="btn btn-color rounded-0 pt-0 pb-0 pr-2 pl-2">Powrót</a>
                        <c:if test="${not empty errorMessage}">
                            <div class="alert alert-danger" role="alert">
                                    ${errorMessage}
                            </div>
                        </c:if>
                        <form action="/guest/rateactor" method="POST" style="display: inline-block;">
