                ...
                <div class="border-dashed view-height w-100">
                    <div class="mt-4 ml-4 mr-4">
                        <div class="row border-bottom border-3">
                            <div class="col"><h3 class="color-header text-uppercase">Szczegóły aktora</h3></div>
                            <div class="col d-flex justify-content-end mb-2">
                                <a href="/app/actors" class="btn btn-color rounded-0 pt-0 pb-0 pr-2 pl-2">Powrót</a>
                                <c:if test="${not empty errorMessage}">
                                    <div class="alert alert-danger" role="alert">
                                            ${errorMessage}
                                    </div>
                                </c:if>
                                <form action="/app/rateactor" method="POST" style="display: inline-block;">
                                    <input type="hidden" name="actorId" value="${actor.id}"/>
                                    <select class="form-select rounded-0 pt-0 pb-0 pr-2 pl-2" id="actorRating" name="rating"
                        ...
                        <table class="table borderless">
                            ...
                            <tr class="d-flex">
                                ...
                                <td class="col-7">${actor.firstName}</td>
                            </tr>
                            <tr class="d-flex">
                                <th scope="row" class="col-2">Nazwisko:</th>
                                <td class="col-7">${actor.lastName}</td>
                            </tr>
                            <tr class="d-flex">
                                <th scope="row" class="col-2">Ocena:</th>
                                <td class="col-7">${actor.rating}</td>
                            </tr>
                            <tr class="d-flex">
                                <th scope="row" class="col-2">Ilość wyświetleń:</th>
                                <td class="col-7">${actor.views}</td>
                            </tr>
                            <tr class="d-flex">
                                <th scope="row" class="col-2">Grał w:</th>
                                <td class="col-7">
                                    <ul>
